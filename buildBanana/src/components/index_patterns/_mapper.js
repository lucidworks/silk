    ...
    function Mapper() {
      ...
      self.getFieldsForIndexPattern = function (indexPattern, skipIndexPatternCache) {
        ...
        return promise.then(function (indexList) {
          ...
          var solrFieldsUrl = configFile.apollo + '/collections/' + indexList + '/schema/fields';
          var solrDynamicFieldsUrl = configFile.apollo + '/collections/' + indexList + '/schema/dynamicfields';
